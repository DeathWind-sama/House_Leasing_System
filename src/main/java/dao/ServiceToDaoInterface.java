...
//    boolean getAllTenant(ArrayList<Tenant> tenantArrayList);//返所有租赁者（管理员权限）
    ...
    ArrayList<CommunicationAuthority> getOwnCommunicationAuthorities(String ID,boolean isHomeowner);//返回一个人的所有交流许可
    ...
    ArrayList<VisitRecord> getOwnVisitRecords(String ID,boolean isHomeowner);//返回一个人的所有的看房记录
//    boolean getAllVisitRecord(ArrayList<VisitRecord> visitRecordArrayList);//返回所有的看房记录（管理员权限）
    ...
    ArrayList<Contract> getOwnContracts(String ID,boolean isHomeowner);//返回一个人的所有合同
